 ...
 */
public class UploadFragment extends AbstractVideoFragment {
    /**
    ...
    private void getVideos(){
        if(!ListUtils.isEmptyList(videos.get(YoutubeHelper.UPLOAD_VIDEO_TYPE))) {
            videoListAdapter.addVideoList(videos.get(YoutubeHelper.UPLOAD_VIDEO_TYPE));
        }
        else{
            new GetYoutubeVideosTask(youtube,this).execute(YoutubeHelper.UPLOAD_VIDEO_TYPE);
        }
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        this.mCallbacks.onItemSelected(Long.toString(id), YoutubeHelper.UPLOAD_VIDEO_TYPE);
    }
}
